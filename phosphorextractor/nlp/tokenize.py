...
class ChemWordTokenizer(WordTokenizer):
    ...
    NO_SPLIT_CHEM = re.compile('([\-α-ω]|\d+,\d+|[α|x|y|δ|β|γ]|\d+[A-Z]|^d\d\d?$|[A-Z][a-z]|[ONS]|[A-Z][a-z]\d+|Eu|Ce|Mn|Tb|acetic|acetyl|acid|acyl|anol|azo|benz|bromo|carb|cbz|chlor|cyclo|ethan|ethyl|fluoro|fmoc|gluc|hydro|idyl|indol|iene|ione|iodo|mercapto|n,n|nitro|noic|o,o|oxalo|oxo|oxy|oyl|onyl|phen|phth|phospho|pyrid|telluro|tetra|tms|ylen|yli|zole|alpha|beta|gamma|delta|epsilon|theta|kappa|lambda|sigma|omega)', re.U | re.I)
    #: Don't split on hyphen if the prefix is one of these sequences
    NO_SPLIT_PREFIX = {
        'e', 'a', 'u', 'x', 'agro', 'ante', 'anti', 'arch', 'be', 'bi', 'bio', 'co', 'counter', 'cross', 'cyber',
        'de', 'eco', 'ex', 'extra', 'inter', 'intra', 'macro', 'mega', 'micro', 'mid', 'mini', 'multi', 'neo', 'non',
        'over', 'pan', 'para', 'peri', 'post', 'pre', 'pro', 'pseudo', 'quasi', 're', 'semi', 'sub', 'super', 'tri',
        'ultra', 'un', 'uni', 'vice','Eu2+','Ce3+','Eu3+','Mn4+',
    ...
    SPLIT_SUFFIX = {
        ...
        'acid', 'activation', 'active', 'activity', 'addition', 'adducted', 'adducts', 'adequate',
        ...
        'donating', 'donor', 'dopant', 'dosed', 'dot', 'drinking', 'driven', 'drug', 'drugs', 'dye',
