...
#import numpy as np
import six
from ..reader.markup import HtmlReader,XmlReader,JsonReader
...
class Snowball(object):
    ...
    def extract(self, s):
        ...
        #print('sentence_tagged_tokkens:',s.tagged_tokens)
        num_candidates = len(candidate_relations)
        all_combs = []
        unique_names = set()
        for i in candidate_relations:
            for j in i.entities:
                if j.tag in ['phosphor', 'phosphor-1','phosphor-2','phosphor-3','phosphor-4','phosphor-5','phosphor-6']:
        ...
        for combination in all_combs:
            ...
            #print('candidate_phrase_relation:',candidate_phrase.relations)
